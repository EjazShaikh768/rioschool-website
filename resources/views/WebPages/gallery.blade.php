        ...
        <div class="col-12">
            ...
            <section id="galleryBG">
                <div class="container my-5 py-5">
                        ...
                        <div class="col-sm-12 col-md-4 col-lg-4 galleryCard" data-aos="fade-down">
                            <img src={{ asset('images/activity/3.jpeg') }} class="img-fluid" alt="">
                        </div>
                        <div class="col-sm-12 col-md-2 col-lg-2 galleryCard" data-aos="fade-down">
                            <img src={{ asset('images/activity/2.jpeg') }} class="img-fluid" alt="">
                        </div>
                        <div class="col-sm-12 col-md-2 col-lg-2 galleryCard" data-aos="fade-down">
                            <img src={{ asset('images/activity/4.jpg') }} class="img-fluid" alt="">
                        </div>
                        <div class="col-sm-12 col-md-3 col-lg-3 galleryCard" data-aos="fade-down">
                            <img src={{ asset('images/activity/8.jpg') }} class="img-fluid" alt="">
                        </div>
                    </div>
                        <div class="row justify-content-around">
                        <div class="col-sm-12 col-md-2 col-lg-2 galleryCard1" data-aos="slide-left">
                            <img src={{ asset('images/activity/5.jpg') }} class="img-fluid" alt="">
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-6 galleryCard1" data-aos="slide-left">
                            <img src={{ asset('images/activity/6.webp') }} class="img-fluid" alt="">
                        </div>
                        <div class="col-sm-12 col-md-4 col-lg-4 galleryCard1" data-aos="slide-left">
                            <img src={{ asset('images/activity/7.png') }} class="img-fluid" alt="">
                        </div>
                    
                        </div>
                        <div class="row justify-content-around">
                            <div class="col-sm-12 col-md-2 col-lg-2 galleryCard" data-aos="slide-right">
                              <img src={{ asset('images/activity/8.jpg') }} class="img-fluid" alt="">
                            </div>
                            <div class="col-sm-12 col-md-2 col-lg-2 galleryCard" data-aos="slide-right">
                             <img src={{ asset('images/activity/10.jpg') }} class="img-fluid" alt="">
                            </div>
                            <div class="col-sm-12 col-md-3 col-lg-3 galleryCard" data-aos="slide-right">
                                 <img src={{ asset('images/activity/11.jpg') }} class="img-fluid" alt="">
                            </div>
                            <div class="col-sm-12 col-md-2 col-lg-2 galleryCard" data-aos="slide-right">
                             <img src={{ asset('images/activity/12.jpeg') }} class="img-fluid" alt="">
                            </div>
                         <div class="col-sm-12 col-md-2 col-lg-2 galleryCard" data-aos="slide-right">
                            <img src={{ asset('images/activity/13.jpg') }} class="img-fluid" alt="">
                        </div>
                    </div>

                    <div class="row justify-content-around">
                            <div class="col-sm-12 col-md-3 col-lg-3 galleryCard1" data-aos="slide-up">
                              <img src={{ asset('images/activity/8.jpg') }} class="img-fluid" alt="">
                            </div>
                            <div class="col-sm-12 col-md-3 col-lg-3 galleryCard1" data-aos="slide-up">
                             <img src={{ asset('images/activity/10.jpg') }} class="img-fluid" alt="">
                            </div>
                            <div class="col-sm-12 col-md-2 col-lg-2 galleryCard1" data-aos="slide-up">
                             <img src={{ asset('images/activity/12.jpeg') }} class="img-fluid" alt="">
                            </div>
                         <div class="col-sm-12 col-md-3 col-lg-3 galleryCard1" data-aos="slide-up">
                            <img src={{ asset('images/activity/13.jpg') }} class="img-fluid" alt="">
                    ...
                    <!-- <div class="row justify-content-center">
                        ...
                        <center>  <h1> <img src={{ asset('images/photo-camera.gif') }} class="img-fluid" width="60px" alt="camera logo"> OUR IMAGE GALLERY</h1></center>
                        </div>
                    </div> -->
