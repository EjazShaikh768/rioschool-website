 ...
 <section id="managmentBreadcamp">
    <div class="row">
        <div class="col-12">
            ...
            <div class="centered">
            <h1>ABOUT US</h1>
            <h4>ABOUT  <b> > </b> <span >ABOUT</span></h4>
            </div> 
        </div>
    </div>
</section>
      ...
      <div class="row px-3 my-5">
            <div class="col-sm-12 col-md-6 col-lg-6 mt-3  justify" data-aos="slide-right">
<img src={{ asset('images/activity/7.png') }} alt="" class="img-fluid mt-5" >
            </div>
            <div class="col-sm-12 col-md-6 col-lg-6">
                <div class="row">
                    <div class="col-sm-12 col-md-10 col-lg-10 justify" data-aos="slide-left">
                        <h2>HSWD School</h2>
                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Tempora possimus cumque quo soluta explicabo reiciendis eaque obcaecati? Provident maiores corrupti, ducimus libero, tempora nemo pariatur voluptatibus quod deleniti maxime enim totam reprehenderit distinctio officia
                        ...
                        <p>Provident maiores corrupti, ducimus libero, tempora nemo pariatur voluptatibus quod deleniti maxime enim totam reprehenderit distinctio officia
                             autem dolorum iure! Perspiciatis praesentium vitae animi quo minus. Placeat mollitia quidem numquam consectetur distinctio. Ipsa.</p>
        ...
        <div class="container mb-5">
            <div class="row px-3 justify-content-center">
                <div class="col-sm-12 col-md-8 col-lg-7 justify" >
                    <img src={{ asset('images/activity/8.jpg') }} alt="" class="img-fluid" data-aos="slide-down">
                 <div class="text" data-aos="slide-up">
                 <h3>About My Managment</h3>
                      <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Harum quisquam porro, ut atque, laboriosam perferendis omnis hic voluptate, delectus qui cumque beatae consectetur consequatur voluptatibus tempora.
                         Velit officiis sapiente deleniti voluptas similique ipsa dolorem, omnis, adipisci tempora ab qui nesciunt.</p>
                       <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Reiciendis quasi temporibus quisquam beatae quos deleniti nisi consequuntur, officia sint a perspiciatis velit quam maxime cum optio nemo eveniet ducimus provident.</p>
