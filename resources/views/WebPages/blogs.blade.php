     ...
     <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse" id="navbarScroll">
                                <ul class="navbar-nav m-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                                    ...
                                    <li class="nav-item">
                                    <a class="nav-link active" href="{{'blog'}}">ACHIEVEMENT</a>
                                    </li>
...
<section>
    <div class="container">
        <div class="row px-3 justify-content-around my-5">
            <h1>OUR BLOG'S</h1>
            
            <div class="col-sm-12 col-md-7 col-lg-7 mt-5 blogs box justify">
                 <img src={{ asset('images/activity/16.jpg')}} class="img-fluid" alt="blog one" srcset="" data-aos="flip-down">
                 <h2> Tree Activity</h2>
                 <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Atque aspernatur, ratione quo dolores illo nobis 
                    blanditiis itaque laborum perferendis quia! Voluptatum accusamus quae aspernatur quibusdam veritatis inventore
                    fugiat doloribus dignissimos. Odio autem enim in iure? </p>
                 <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Atque aspernatur, ratione quo dolores illo nobis 
                    blanditiis itaque laborum perferendis quia! Voluptatum accusamus quae aspernatur quibusdam veritatis inventore
                    fugiat doloribus dignissimos. Odio autem enim in iure? 
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Atque aspernatur, ratione quo dolores illo nobis 
                    blanditiis itaque laborum perferendis quia! Voluptatum accusamus quae aspernatur quibusdam veritatis inventore
                    fugiat doloribus dignissimos. Odio autem enim in iure? </p>
                 <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Atque aspernatur, ratione quo dolores illo nobis 
                    blanditiis itaque laborum perferendis</p>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus quos nobis maxime earum tempora est sint sapiente
                         minus nesciunt! Facilis minima quos, ea perferendis corrupti nostrum natus omnis magni aspernatur? quia! Voluptatum accusamus quae aspernatur quibusdam veritatis inventore
                    fugiat doloribus dignissimos. Odio autem enim in iure? </p>
            </div>  
            <div class="col-sm-12 col-md-3 col-lg-3 text-left">
                <div class="row justify-content-center   mt-5">
                    <div class="col-sm-12 box1 " data-aos="slide-left">
                        <img src={{ asset('images/activity/15.jpg')}} class="img-fluid" alt="">
                        <h2>Tree Activity</h2> 
                        <span>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint, laboriosam.</span> <br>
                        <span>Date : <b><?php echo date("d-M-Y") ?></b></span><br>
                        <span>Author : <b>Javed Maniyar</b> </span><br>
                    </div>
                    <div class="col-sm-12 box1 mt-4" data-aos="slide-left">
                    ...
                    <div class="col-sm-12 box1 mt-4" data-aos="slide-left">
                        <img src={{ asset('images/activity/1.jpeg')}} class="img-fluid" alt="">
                        <h2>Tree Activity</h2> 
                        <span>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint, laboriosam.</span> <br>
                        <span>Date : <b><?php echo date("d-M-Y") ?></b></span><br>
                        <span>Author : <b>Javed Maniyar</b> </span><br>
                    </div>
                    <div class="col-sm-12  mt-4" date-aos="fade-up">
