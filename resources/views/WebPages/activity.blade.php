      ...
      <div class="accordion-body">
       <div class="row activity justify-content-around">
            <div class="col-sm-12 col-md-4 ">
                <img src={{ asset('images/activity/5.jpg') }} class="img-fluid" alt="" srcset="" data-aos="slide-right" >
            </div>
            <div class="col-sm-12 col-md-7 " data-aos="slide-left" >
                <h2>Craft Activity Every Saturday</h2>
                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Eius modi ratione natus blanditiis pariatur vel exercitationem, animi alias possimus dolorum accusamus ad quisquam asperiores similique aperiam vitae qui libero expedita esse? Modi, rem ab? Doloribus dolore dolorem, beatae facere facilis voluptas magnam inventore fugit excepturi sequi ducimus non eligendi harum.</p>
            </div>
       </div>  
    </div>
    </div>
