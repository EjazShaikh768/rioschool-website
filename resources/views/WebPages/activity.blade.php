                                ...
                                <div class="accordion-body">
                                    <div class="row activity justify-content-around">
                                        <div class="col-sm-12 col-md-4 ">
                                            <img src={{ asset('images/activity/5.jpg') }} class="img-fluid"
                                                alt="" srcset="" data-aos="slide-right">
                                        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12 text-center">
                    <h6 class="text-white"> <i class="fa-regular fa-copyright"></i> <?php echo date('Y'); ?> <b><a
                                href="https://rioforge.com/">Rioforge</a></b> All Rights Reserved by Rioforge
                        Information Systems</h6>
                </div>
            </div>
        </div>
    </section>
