 ...
 <section id="managmentBreadcamp">
    <div class="row">
        <div class="col-12">
            ...
            <div class="centered">
            <h1>OUR FAMILY</h1>
            <h4>Family   <b> > </b> <span >Teaching Staff</span></h4>
            </div> 
        </div>
    </div>
</section>
...
<section id="teachingstaff">
    <div class="container my-5">
        <div class="row justify-content-center mt-5 px-3">
            <div class="col-12 ">
                <img src={{asset('images/teachergroup.jpg')}} class="img-fluid  " alt="" >
        ...
        <div class="row justify-content-around  my-5 px-3">
            <div class="col-sm-12 col-md-4 " data-aos="slide-left" >
                <img src={{asset('images/teachergroup1.jpg')}} class="img-fluid  mt-5" alt="" >
                <h2>The KG Teaching Staff</h2>
                <center> <div class="divider mt-4"></div></center>
            </div>
            <div class="col-sm-12 col-md-4 ">
                <img src={{asset('images/teachergroup3.jpg')}} class="img-fluid  mt-5" alt="" >
        ...
        <div class="row justify-content-center my-5 px-3">
            <div class="col-12 mt-5">
                <img src={{asset('images/teachergroup4.jpg')}} class="img-fluid " alt="" >
            </div>
        </div>
    </div>
</section>
